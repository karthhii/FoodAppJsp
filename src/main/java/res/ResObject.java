...
public class ResObject {
	...
	String email;
	float avgRating;
	public ResObject(int resId,String resName,String address,String location,String openTime,String closeTime,int gstNumber,int contactNumber,String email,float avgRating){
		this.resId= resId;
